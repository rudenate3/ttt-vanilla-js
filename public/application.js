...
utils.devLog = function (log, file, line) {
...
var BoardModel = __webpack_require__(14);
var utils = __webpack_require__(2);

var pageObject = __webpack_require__(1);

var gameBoardInstance = {};
var gameEnded = true;
var playerXTurn = true;
var turnCount = void 0;
var xWins = 0;
var oWins = 0;
var ties = 0; // TODO add tie ui
var games = 0;
...
var addMove = function addMove(square, player) {
  square.val = player;
...
var onSquareClicked = function onSquareClicked(square) {
  if (gameEnded) {
...
var newGameButton = __webpack_require__(1).newGameButton;
...
var SquareModel = __webpack_require__(15);
var utils = __webpack_require__(2);

var gameBoardContainer = __webpack_require__(1).gameBoardContainer;

var dimension = 3;

var BoardModel = function BoardModel() {
...
var checkAllSamePlayer = function checkAllSamePlayer(player, lineArray) {
  ...
  return lineArray.every(function (square) {
...
BoardModel.prototype.checkForWin = function (player) {
  return checkAllSamePlayer(player, [// Top Row
  this.board[0].val, this.board[1].val, this.board[2].val]) || checkAllSamePlayer(player, [// Middle Row
  this.board[3].val, this.board[4].val, this.board[5].val]) || checkAllSamePlayer(player, [// Bottom Row
  this.board[6].val, this.board[7].val, this.board[8].val]) || checkAllSamePlayer(player, [// First Column
  this.board[0].val, this.board[3].val, this.board[6].val]) || checkAllSamePlayer(player, [// Second Column
  this.board[1].val, this.board[4].val, this.board[7].val]) || checkAllSamePlayer(player, [// Third Column
  this.board[2].val, this.board[5].val, this.board[8].val]) || checkAllSamePlayer(player, [// Diagonal Top-Left > Bottom-Right
  this.board[0].val, this.board[4].val, this.board[8].val]) || checkAllSamePlayer(player, [// Diagonal Bottom-Left > Top-Right
  this.board[6].val, this.board[4].val, this.board[2].val]);
};
...
var SquareModel = function SquareModel(id) {
...
SquareModel.prototype.addClickHandler = function () {
  ...
  $('#' + this.id).on('click', function (event) {
    utils.devLog(_this.id + ' Clicked');
    gameLogic.onSquareClicked(_this);
  });
};
